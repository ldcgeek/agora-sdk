...
class AgoraRtcEnginePlugin : FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
  ...
  fun engine(): RtcEngine? {
    Log.d("RtcEngine", "engine: ${manager.engine}")
    return manager.engine
  }

  fun videoManager(): CameraVideoManager? {
    Log.d("RtcEngine", "videoManager: ${manager.videoManager}")
    return manager.videoManager
  }

  fun fuRenderer(): FURenderer? {
    Log.d("RtcEngine", "fuRenderer: ${manager.fuRenderer}")
    return manager.fuRenderer
  }
