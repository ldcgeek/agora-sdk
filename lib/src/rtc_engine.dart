...
class RtcEngine with RtcEngineInterface {
  ...
  static Future<RtcEngine> create(String appId, String fua, String bsJson, String cameraModels) {
    return createWithContext(RtcEngineContext(appId), fua, bsJson, cameraModels);
  }
  ...
  /// - The error code, if this method call fails:
  ///   - [ErrorCode.InvalidAppId]
  static Future<RtcEngine> createWithContext(RtcEngineContext context, String fua, String bsJson, String cameraModels) async {
  ...
  @override
  Future<void> playEffect(int soundId, String filePath, int loopCount, double pitch, double pan, double gain, bool publish, [int? startPos]) {
  ...
  @override
  Future<String?> takePicture(String filepath) {
    return _invokeMethod('takePicture', {
      'filepath': filepath,
    });
  }
}
